...
import { DropOwner } from "./module/types/market/drop"
...
export { Burnings, Drop, DropOwner, Member, Order, OrderResponse, Params, Pool };
...
const getDefaultState = () => {
	return {
				...
				_Structure: {
						...
						DropOwner: getStructure(DropOwner.fromPartial({})),
